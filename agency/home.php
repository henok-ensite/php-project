        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="add-employee.php" class="btn btn-primary float-end">Add Employee</a>
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-stripe">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT employee.*,company.fname as cfname FROM employee,company WHERE employee.cid=$cid and company.cid=$cid";
